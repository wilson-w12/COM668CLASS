...
@Component({
  ...
  imports: [CommonModule, FormsModule, RouterModule, HighchartsChartModule, MatFormFieldModule, MatInputModule, MatAutocompleteModule, MatSelectModule, ReactiveFormsModule],
})
export class ClassExamDetailsComponent {
  ...
  validateExam(): boolean {
    // Validate presence
    const isTitleValid = this.exam.title && this.exam.title.trim() !== '';
